...
config.JobType.psetName = 'runLongLived2018_MET_EG_cfg.py'
...
if __name__=='__main__':
    ...
    Datasets_2018 = {}
    Datasets_2018['Run2018A']  = '/MET/Run2018A-UL2018_MiniAODv2-v2/MINIAOD'
    Datasets_2018['Run2018B']  = '/MET/Run2018B-UL2018_MiniAODv2-v2/MINIAOD'
    Datasets_2018['Run2018C']  = '/MET/Run2018C-UL2018_MiniAODv2-v1/MINIAOD'
    Datasets_2018['Run2018D']  = '/MET/Run2018D-UL2018_MiniAODv2-v1/MINIAOD'

    # Get datasets
    for key in Datasets_2018.keys():
        dataset = Datasets_2018[key]
