...
process.load("MyAnalysis.IFCALongLivedAnalysis.displacedElectrons_cff")
...
process.displacedElectrons.isData = False
process.displacedElectrons.DSAMode = True
process.displacedElectrons.Era = 2018

process.p = cms.Path(process.displacedElectrons)
