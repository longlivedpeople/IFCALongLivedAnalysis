...
config.General.workArea = 'crab_HToSSTo4l_MHMASSHIGGS_displacedElectrons'
...
config.JobType.psetName = 'runDisplacedElectronAnalyzer_cfg.py'
...
config.Data.outLFNDirBase = '/store/user/fernance/NTuples-displacedElectrons_2018'
config.Data.publication = False
config.Data.outputDatasetTag = 'NTuples-displacedElectrons_2018'
...
if __name__=='__main__':
    ...
    for mp in mass_points:
        ...
        dcommand = """/cvmfs/cms.cern.ch/common/dasgoclient --query="dataset=/ggH_HToSSTo4l_MH-{0}_MS-{1}_ctauS-*_Tune*_13TeV-powheg-pythia8*/*RunIISummer20UL18MiniAODv2ext*/USER instance=prod/phys03 " """.format(mp[0], mp[1])
