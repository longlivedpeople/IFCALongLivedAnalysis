...
config.General.requestName = 'DoubleEG-Run2016B-17Jul2018_ver2-v1_NTuples'
...
config.JobType.psetName = 'runLongLivedEG2016Data_cfg.py'
...
config.Data.outputDatasetTag = 'NTuples-Galapago_Run2016B'
