...
config.General.requestName = 'DoubleMuon-Run2016C-07Aug17-v1_NTuples'
...
# Input dataset (small)
config.Data.inputDataset = '/DoubleMuon/fernance-DoubleMuon-Run2016C-07Aug17-v1_modified_rsb2-42be9799ae70470560a96f9e21287209/USER'
